...
main:   # This is the entry point of our program
    ...
    la    $a0, msg # make $a0 point to where the message is {Load the message into the $a0 register.}
    li    $v0, 4   # $v0 <- 4 {We put a 4 into the $v0 register.}
    syscall        # Call the OS to print the message {Executes interrup FOUR and prints the message}

    # This is the standard way to end a program 
    li    $v0, 10
    syscall        # end the program {Executes interrupt number TEN to end the program.}
